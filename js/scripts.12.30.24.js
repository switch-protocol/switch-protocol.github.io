...
const links = {
    artist_one_social: "https://soundcloud.com/mike-extern",
    artist_two_social: "https://soundcloud.com/cb-asher",
    artist_three_social: "https://soundcloud.com/eun-jin-chung-897106552",
    ...
    calendar_link: "https://ra.co/events/2332194",
    ra_link: "https://ra.co/events/2332194",
...
function animateText(target, duration = 1500, intervalTime = 15, charTurns = 3) {
    ...
    const interval = setInterval(() => {
        ...
        target.innerHTML = targetText.split("").map((letter, index) => {
            // Handle spaces
            if (letter === " ") {
                return `<span>&nbsp;</span>`;  // Return non-breaking space in a span
            }
...
window.onload = function () {
    ...
    h1Elements.forEach((h1) => {
        intervals[h1.dataset.value] = animateText(h1, 1000, 35, 3);
    });

    const h2Elements = document.querySelectorAll("h2");
    h2Elements.forEach((h2) => {
        intervals[h2.dataset.value] = animateText(h2, 2500, 35, 2.5);
    });
